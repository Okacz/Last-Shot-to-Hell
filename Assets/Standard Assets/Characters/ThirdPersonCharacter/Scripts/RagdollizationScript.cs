...
public class RagdollizationScript : MonoBehaviour {
    ...
    public void Ragdollize(Collider aa, float force)
    {
        ...
        foreach (Rigidbody b in GetComponentsInChildren<Rigidbody>())
        {
            ...
            if (b.name == "Pelvis")
            {
                ...
                b.GetComponent<Rigidbody>().AddForce(aa.transform.up * GetComponent<Rigidbody>().mass * 1000*force);
    ...
    {
        //transform.position = transform.FindChild("R Foot").position;
